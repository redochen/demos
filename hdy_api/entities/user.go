...
//用户表名称
func (self *UserEntity) TableName() string {
	return "user"
}
...
//关系表名称
func (self *RelationEntity) TableName() string {
	return "relation"
}
...
//邀请表名称
func (self *InvitationEntity) TableName() string {
	return "invitation"
}
...
//评价表名称
func (self *EvaluationEntity) TableName() string {
	return "evaluation"
}
